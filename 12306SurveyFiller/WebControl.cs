...
namespace SurveyFiller
{
    public class WebControl
    {
        ...
        public String FillSurvey(SurveyBaseInfo sbi, int option)
        {
            ...
            msg = PostSurvey(PostData);
            return msg;
        }

        public String FetchValidationCode(String userName)
        {
            String PostData = "userName=" + userName + "&oldUserName=";
            String st = PostHttpRequest("http://dynamic.12306.cn/surweb/registAction.do?method=sendSm", PostData);
            //To be complemented sth. on dealing with result
            return null;
        }

        public String PostValidationCode(String validationCode)
        {
